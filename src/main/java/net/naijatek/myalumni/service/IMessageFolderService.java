...
/**
 * This is an interface to the Message Folder service implementation.
 *
 * @author Folashade Adeyosoye
 * @version 1.0
 */
public interface IMessageFolderService extends BaseCrudService<MessageFolderVO, String>{
