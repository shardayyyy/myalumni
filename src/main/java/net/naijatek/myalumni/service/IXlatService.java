...
public interface IXlatService{
    ...
    public void updateXlatDetail( String userId, String groupId, String lookupCodeId, String status, String label) throws MyAlumniException;
