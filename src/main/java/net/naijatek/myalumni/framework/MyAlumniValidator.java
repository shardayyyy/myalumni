...
import net.naijatek.myalumni.controller.MyAlumniBaseController;
...
//		}
    ...
    public void compareClassNewsYear(Object target, Errors errors) {
        ...
        if (toClassYear < fromClassYear) {
            //@TODO messages.add(field.getKey(), Resources.getActionMessage(request,va, field));
        }
    ...
    public void compareReminisceYear(Object target, Errors errors) {
        ...
        ReminisceVO reminisceForm = (ReminisceVO) target;
    ...
    public void validateFrontPageUrl(Object target, Errors errors) {
        ...
        FrontPageVO form = (FrontPageVO) target;
    ...
    public void searchCategory(Object target, Errors errors) {
        ...
        String yearIn = StringUtil.safeString(memForm.getYearIn().toString());
        String yearOut = StringUtil.safeString(memForm.getYearOut().toString());
    ...
    // --------------------------------------------------------------------------------------
    public void requiresDeleteId(Object target, Errors errors, HttpServletRequest request) {
        String[] mailArray = new String[0];

        PrivateMessageVO pmForm = (PrivateMessageVO) target;
    ...
    public void adminMaintainScroll(Object target, Errors errors) {
        ...
        ScrollVO scrollForm = (ScrollVO) target;
    ...
    public void comparePassword(Object target, Errors errors) {
        ...
        if (!newpassword.equals(newpasswordConfirm)) {
            //@TODO messages.add(BaseConstants.WARN_KEY, new ActionMessage("errors.password.notequal"));
            //@TODO saveMessages(request, messages);
        }
        // }
        //return messages.isEmpty();
    }
