...
public class AppProp {
  private static Log logger = LogFactory.getLog(AppProp.class);


  private Properties properties;
  private final static AppProp CFG = new AppProp();
  private final static String PROPERTY_FILENAME = "ApplicationResources.properties";
