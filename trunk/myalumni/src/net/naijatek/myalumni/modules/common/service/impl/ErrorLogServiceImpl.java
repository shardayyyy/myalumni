...
public class ErrorLogServiceImpl implements IErrorLogService {
    ...
    public ErrorLogVO getErrorLog(String logId) {
        ...
        return errorLogDao.getErrorLog(logId);
    }
    ...
    public List<LoginHistoryVO> getAllAccessLogs() {
        ...
        return errorLogDao.getAllAccessLogs();
    }
    
    public void deleteAllAccessLogs() throws MyAlumniException {
        
        errorLogDao.deleteAllAccessLogs();
    }

	public List<LoginHistoryVO> getAccessLogs(String username) {		
		return errorLogDao.getAccessLogs(username);
	}
}
