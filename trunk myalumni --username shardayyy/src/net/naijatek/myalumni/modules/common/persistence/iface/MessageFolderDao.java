...
public interface MessageFolderDao  extends BaseCrudDao<MessageFolderVO, String>{
  ...
  public int getMailFolderCount(String folderName, String memberUserName, String status);
