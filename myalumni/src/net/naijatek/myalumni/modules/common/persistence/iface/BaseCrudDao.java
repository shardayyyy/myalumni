 ...
 */
public interface BaseCrudDao<T, ID extends Serializable> {
	 ...
	 */
	public void hardDeleteObject(ID id) throws MyAlumniException;
	
	/**
	 * Update the status to been inactive.
	 * @param id The id of the entity to delete
	 * @throws AdminException
	 */
	public void softDeleteObject(ID id, String lastModifiedBy) throws MyAlumniException;
