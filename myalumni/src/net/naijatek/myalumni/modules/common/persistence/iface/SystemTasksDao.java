...
public interface SystemTasksDao{

  public void systemDatabaseBackup(String dbName, String dbDialet, String dbUser, String dbPswd, String dbIpAddress, String dbPort, String dumpPath, String dbPath) throws MyAlumniBaseException;
