...
public class ContactsControllers
{
 ...
 {
  //ModelAndView mav = new ModelAndView("/WEB-INF/jsp/showContacts.jsp");
 ...
 {
  //ModelAndView mav = new ModelAndView("/WEB-INF/jsp/newContact.jsp");
 ...
 public String create(@ModelAttribute("newContact")Contact contact, BindingResult result, SessionStatus status)
 {
  ...
  if (result.hasErrors())
  {   
//   return "/WEB-INF/jsp/newContact.jsp";
     return "newContact";
  }
 ...
 {
  //ModelAndView mav = new ModelAndView("/WEB-INF/jsp/editContact.jsp");
 ...
 public String update(@ModelAttribute("editContact") Contact contact, BindingResult result, SessionStatus status)
 {
  validator.validate(contact, result);
  if (result.hasErrors()) {
   //return "/WEB-INF/jsp/editContact.jsp";
   return "editContact";
  }
