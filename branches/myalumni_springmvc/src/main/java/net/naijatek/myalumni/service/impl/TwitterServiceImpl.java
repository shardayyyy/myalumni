...
import net.naijatek.myalumni.persistence.hibernate.SystemConfigHibernateDao;
import net.naijatek.myalumni.service.ITwitterService;
...
/*    public TwitterServiceImpl(SystemConfigHibernateDao SysConfigDao) {
	...
	public void updateTwitterCredentials(TwitterVO twitterVO){
		SysConfigDao.updateTwitterCredentials(twitterVO);
