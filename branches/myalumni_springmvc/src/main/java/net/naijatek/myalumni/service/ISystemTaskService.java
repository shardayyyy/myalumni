 ...
 * @version 1.0
 */
package net.naijatek.myalumni.service;

import java.util.List;

import net.naijatek.myalumni.controller.exceptions.MyAlumniBaseException;
import net.naijatek.myalumni.entity.EmailExceptionVO;



/**
 * This is an interface to the System Task service implementation.
 *
