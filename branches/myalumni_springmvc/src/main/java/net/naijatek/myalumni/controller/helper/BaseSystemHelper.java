...
public class BaseSystemHelper {
    ...
    public MyAlumniMessages validateSystemConfig() {
		...
		try {
		      ...
		      if (springProperties.getProperty(key).trim() == null || springProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00901"));
		      }
		      
		      key = "dbip";			      
		      if (springProperties.getProperty(key).trim() == null || springProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00902"));
		      }

		      key = "dbname";			      
		      if (springProperties.getProperty(key).trim() == null || springProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00903"));
		      }

		      key = "dbport";			      
		      if (springProperties.getProperty(key).trim() == null || springProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00904"));
		      }

		      key = "username";			      
		      if (springProperties.getProperty(key).trim() == null || springProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00905"));
		      }

		      key = "password";			      
		      if (springProperties.getProperty(key).trim() == null || springProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00906"));
		      }

		      key = "dbpath";			      
		      if (springProperties.getProperty(key).trim() == null || springProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00907"));
		      }
		...
		try {
		      ...
		      if (log4jProperties.getProperty(key).trim() == null || log4jProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00911"));
		      }
		      
		      key = "log4j.appender.FILE.File";			      
		      if (log4jProperties.getProperty(key).trim() == null || log4jProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00912"));
		      }			      
		}
		catch (Exception ex) {
		...
		try {
		      ...
		      if (mailProperties.getProperty(key).trim() == null || mailProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00921"));
		      }	
		      
		      key = "mail.smtp.password";			      
		      if (mailProperties.getProperty(key).trim() == null || mailProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00922"));
		      }	
		      
		      key = "mail.smtp.host";			      
		      if (mailProperties.getProperty(key).trim() == null || mailProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00923"));
		      }	
		      
		      key = "mail.smtp.default.from";			      
		      if (mailProperties.getProperty(key).trim() == null || mailProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00924"));
		      }	
		      
		      key = "mail.smtp.port";			      
		      if (mailProperties.getProperty(key).trim() == null || mailProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00925"));
		      }	
		      
		      key = "mail.smtp.socketFactory.port";			      
		      if (mailProperties.getProperty(key).trim() == null || mailProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00926"));
		      }	
		      
		      key = "mail.smtp.socketFactory.class";			      
		      if (mailProperties.getProperty(key).trim() == null || mailProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00927"));
		      }	
		      
		      key = "mail.smtp.socketFactory.fallback";			      
		      if (mailProperties.getProperty(key).trim() == null || mailProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00928"));
		      }				      
		}
		catch (Exception ex) {
		...
		try {
		      ...
		      if (systemProperties.getProperty(key).trim() == null || systemProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00931"));
		      }	
		      
		      
		      key = "AVATAR.FILEPATH";			      
		      if (systemProperties.getProperty(key).trim() == null || systemProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00932"));
		      }	
		      
		      
		      key = "LOGFILE.FILEPATH";			      
		      if (systemProperties.getProperty(key).trim() == null || systemProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00933"));
		      }	
		      
		      
		      key = "BACKUP.FILEPATH";			      
		      if (systemProperties.getProperty(key).trim() == null || systemProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00934"));
		      }		
		      
		      key = "LOGO.FILEPATH";			      
		      if (systemProperties.getProperty(key).trim() == null || systemProperties.getProperty(key).trim().equals("")){
		    	  errors.add(BaseConstants.WARN_KEY, new MyAlumniMessage("core.errorcode.00935"));
		      }			      
		}
		catch (Exception ex) {
